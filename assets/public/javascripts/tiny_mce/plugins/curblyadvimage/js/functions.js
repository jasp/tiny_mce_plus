...
function srcListSelectionChange(src_list) {
  $('#src').value = this.options[this.selectedIndex].value;
  $('#alt').value = this.options[this.selectedIndex].text;
  $('#title').value = this.options[this.selectedIndex].text;
  ImageDialog.showPreviewImage(this.options[this.selectedIndex].value);
}
...
function ts_onload(){
  ...
  $(iframe1).attr('id','html_editor_image_upload_frame');
